...
# Mathematical computation taken from: https://github.com/tjjones6/Physics-361-Final-Project/blob/main/Code/inviscid-incompressible-cylinder.py
        # Computational grid
...
#.npz data format is vibe coded partially on: Claude (Sonnet4.6)
